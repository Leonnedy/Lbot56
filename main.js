...
global.mods = ['5491130510231'] // Want some help?
global.prems = ['528441249591'] // Premium user has unlimited limit
...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'Este comando solo puede ser utilizado por _*LEO/LAURA*_',
    owner: 'Este comando solo puede ser utilizado por _*LAURA*_!',
    mods: 'Este comando solo puede ser utilizado por _*MAY*_ !',
    premium: 'Este comando solo puede ser utilizado por _*AIDEN*_ !',
    group: '¡Este comando solo se puede usar en grupos!',
    private: '¡Este comando solo se puede usar en chats privados!',
    admin: '¡Este comando es solo para grupos * Admins*!',
